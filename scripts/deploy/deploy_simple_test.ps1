...
Write-Host "Target: 192.168.213.5" -ForegroundColor Cyan
Write-Host ""
...
try {
    wsl scp test_simple.py pi@192.168.213.5:/home/pi/
    ...
    Write-Host "2. SSH to Pi: ssh pi@192.168.213.5"
...
Write-Host "1. SSH to Pi: ssh pi@192.168.213.5" -ForegroundColor Cyan
