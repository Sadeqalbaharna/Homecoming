...
class _ChatGPTImportScreenState extends State<ChatGPTImportScreen> {
  ...
  Future<void> _fetchFromGPT() async {
    ...
    try {
      ...
      const prompt =
          'Please provide a comprehensive memory summary about me. '
      ...
      if (_u != null) UsageTrackingService.trackOpenAI(
        ...
        outputTokens: _u['completion_tokens'] as int? ?? 0, operation: 'chatgpt_import',
      ).catchError((_) {});
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text(
          ...
          style: TextStyle(color: _gold, fontSize: 16, fontWeight: FontWeight.w400),
        ),
      ),
      body: SafeArea(
            ...
            children: [
                ...
                child: const Column(
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      style: TextStyle(color: _goldDim, fontSize: 12, height: 1.6),
                    ),
                  ],
                ),
              ),
                ...
                child: OutlinedButton.icon(
                  ...
                  icon: _fetching
                      ...
                      : const Icon(Icons.auto_awesome_outlined,
                          color: _gold, size: 16),
                  label: Text(
                    _fetching ? 'Asking GPT for memories…' : 'Auto-fetch from GPT',
                ...
                child: Row(children: [
                  ...
                  Padding(
                    ...
                    child: Text('or paste manually',
                        style: TextStyle(color: Color(0x44FFE7B0), fontSize: 11)),
                  ),
                  Expanded(child: Divider(color: Color(0x22FFE7B0))),
                ]),
              ),
              ...
              Container(
                ...
                child: TextField(
                  ...
                  maxLines: 14,
                  style: const TextStyle(color: _gold, fontSize: 13, height: 1.6),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(12),
        border: Border.all(color: Colors.greenAccent.withOpacity(0.25), width: 0.5),
      ),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          ...
          _stat('Personality context', result.personalityUpdated ? 'Updated' : 'Skipped'),
          if (result.summary.isNotEmpty) ...[
            ...
            Text(
              ...
              style: const TextStyle(
                  color: _gold, fontSize: 12, height: 1.6, fontStyle: FontStyle.italic),
            ),
          ],
        ],
      ),
