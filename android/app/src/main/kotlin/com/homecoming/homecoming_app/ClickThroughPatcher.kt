            ...
            try {
                ...
                for (name in viewRootNames) {
                    ...
                    if (view != null) {
                        ...
                        if (params != null && params.type == WindowManager.LayoutParams.TYPE_APPLICATION_OVERLAY) {
                            ...
                            android.util.Log.d("ClickThroughPatcher", "✅ Successfully patched overlay with FLAG_NOT_TOUCH_MODAL!")
                            break
                        }
                    }
                }
